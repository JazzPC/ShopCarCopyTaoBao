...
typedef void(^selectSpeDone)(NSString *,NSString *);

@class CarDetailModel;
@interface ShopCarSpecificationsView : UIView

@property (nonatomic, copy) selectSpeDone selectSpeBlock;
